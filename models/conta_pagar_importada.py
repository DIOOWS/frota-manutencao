...
class ContaPagarImportada(db.Model):
    __tablename__ = "contas_pagar_importadas"
    ...
    # e relatório de pagamento.
    chave_conciliacao = db.Column(db.String(255), index=True)

    # Exemplo: VENCIMENTO, PAGAMENTO, MANUAL, IMPORTACAO
